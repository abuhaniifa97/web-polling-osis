...
if($user->sesi()==1){ ?>
	...
	<li><a href="printdta.php"><i class="icon-book icon-white"></i>Print Data</a></li>
...
<?php }elseif($user->sesi()==2){
	echo "<li><a href=\"?mod=pemilu\"><i class=\"icon-th-large icon-white\"></i>Pilih</a></li>";
	echo "<li><a href=\"?mod=logout\"><i class=\"icon-off icon-white\"></i> LOGOUT</a></li>";
}
?>
</ul>
<div class="btn-group pull-right">
	<button class="btn btn-success"><i class="icon-user icon-white"></i> <?php echo $_SESSION['nama']; ?></button>
</div>